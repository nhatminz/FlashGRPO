...
def main() -> None:
    parser = argparse.ArgumentParser(description="Train FlashGRPO with the independent B200 package")
    parser.add_argument("--config", required=True)
    parser.add_argument("--set", action="append", default=[], help="Override a dotted config key")
